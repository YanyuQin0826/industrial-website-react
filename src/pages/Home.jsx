  ...
  en: [
    {
      ...
      image: 'https://via.placeholder.com/400x200?text=Advanced+Tech',
    },
    {
      ...
      image: 'https://via.placeholder.com/400x200?text=Innovation+Services',
    },
    {
  ...
  cn: [
    {
      ...
      path: '/business/advanced-tech',
      image: 'https://via.placeholder.com/400x200?text=先进技术',
    },
    {
      title: '创新促进',
      description: '通过战略性创新促进服务，推动全球合作。',
      path: '/business/innovation',
      image: 'https://via.placeholder.com/400x200?text=创新服务',
    },
    {
      title: '技术咨询与优化',
      description: '提供专业建议、技术优化与落地咨询服务。',
      path: '/business/consulting',
      image: 'https://via.placeholder.com/400x200?text=技术咨询',
    },
  ],
};
